...
//    private static final Logger LOGGER = Logger.getLogger(JSONFlattener.class);
	...
	/**
	 * Parse the JSON content at the given URI using the default character encoding
	 * UTF-8
	 *
	 * @param uri
	 * @return
	...
	//CUSTOM
	public static List<Map<String, String>> parseJson(InputStream json, String encoding) throws IOException {
		List<Map<String, String>> flatJson = null;
		...
		try {
			...
			// LOGGER.info("Handle the JSON String as JSON Array");
			flatJson = handleAsArray(jsonData);
		}
	...
	private static List<Map<String, String>> handleAsArray(String json) {
		...
		try {
			...
			// LOGGER.error("JSON might be malformed, Please verify that your JSON is
			// valid");
		}
	 ...
	 *
	 * This method will convert the JSON object to a Map of String keys and values
	 *
	 * @param obj
	 * @param flatJson
	 * @param prefix
